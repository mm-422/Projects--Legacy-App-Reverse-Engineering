...
## Initial Assumptions
One reason I chose Puzzleball 3D for this project was the assumption that its "archaic" activation mechanism would be relatively simple to analyze and even overcome with a "bit flip" or conditional check modification.
...
## Analysis Structure
As outlined in the introductory README, the overall plan (initially at least) is to move from:<br>
